function printliminator() {
    ...
    $('<div>').css({
        ...
        $(this).css({'background-position': '-222px -256px'});
    }, function() {
        $(this).css({'background-position': '-222px -182px'});
    }).active(function() {
        $(this).css({'background-position': '-222px -330px'});
    }, function() {
        $(this).css({'background-position': '-222px -182px'});
    }).appendTo(controls);
    ...
    $('<div>').css({
        ...
        $(this).css({'background-position': '-74px -256px'});
    }, function() {
        $(this).css({'background-position': '-74px -182px'});
    }).active(function() {
        $(this).css({'background-position': '-74px -330px'});
    }, function() {
        $(this).css({'background-position': '-74px -182px'});
    }).click(function() {
    ...
    $('<div>').css({
        ...
        $(this).css({'background-position': '-222px -39px'});
    }, function() {
    ...
    $('<div>').css({
        ...
        $(this).css({'background-position': '-148px -256px'});
    }, function() {
        $(this).css({'background-position': '-148px -182px'});
    }).active(function() {
        $(this).css({'background-position': '-148px -330px'});
    }, function() {
        $(this).css({'background-position': '-148px -182px'});
    }).click(function() {
